...
function textToWork(X,Y) {
    ...
    <div class="a-1" id="a-1">
                ...
                <div class="a-2 tooltip">
                    <button class="btn-3" onclick="copyText()" onmouseout="outFunc()"> <span class="tooltiptext" id="myTooltip" >Copiar al portapapeles</span>Copiar<lord-icon src="https://cdn.lordicon.com/pqxdilfs.json" trigger="hover"
